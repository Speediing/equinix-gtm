...
const JOB_ART: Record<JobId, string> = {
  "account-brief": "/brand/equinix-watercolor-header.png",
  "product-follow-up": "/brand/equinix-watercolor-header.png",
  "public-signal": "/brand/equinix-watercolor-header.png",
};
